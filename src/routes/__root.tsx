  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Paste a job description. Northline tailors an ATS resume to the overlap, then shows the skills you still need and open-source projects that close the gap.",
      },
